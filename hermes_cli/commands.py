...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("batch", "Manage workout screenshot batches", "Health",
               gateway_only=True,
               args_hint="[status|review|confirm|reject image|edit field|commit|undo last import]",
               subcommands=("status", "review", "confirm", "reject", "edit", "commit", "undo")),
